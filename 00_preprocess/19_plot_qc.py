...
def aggregate_split_losses(infile):
    ...
    11_parse_igblast.py        parsed_igblast  6083
    11_parse_igblast.py        no_hits_found   16
    11_parse_igblast.py        no_CDR3_start   35
        etc ...
    # now it repeats for another split file
    11_parse_igblast.py        parsed_igblast  6064
    11_parse_igblast.py        no_hits_found   19 
    11_parse_igblast.py        no_CDR3_start   25
        etc...    ''' 
    losses_dict = {}
